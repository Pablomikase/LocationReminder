 ...
 */
fun NotificationManager.sendGeofenceEnteredNotification(context: Context, foundIndex: Int, notificationContent: String) {
    val contentIntent = Intent(context, AuthenticationActivity::class.java)
