...
import com.udacity.project4.authentication.errorMessage
...
class GeofenceTransitionsJobIntentService : JobIntentService(), CoroutineScope {
    ...
    companion object {
        ...
        private const val TAG = "GeofenceTransitionsJI"
    ...
    override fun onHandleWork(intent: Intent) {
        ...
        if (geofencingEvent.geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER) {
            ...
            notificationManager.sendGeofenceEnteredNotification(
                context, 0, intent.getStringExtra("notificationContent")!!
            )*/

            //sendNotification(context, GeofencingConstants.FAKE_DATA[0])
